...
# Backend deployed as a service file on an AWS VPS running on a Linux machine to handle real-time attack monitoring, payload capturing, logging, and notifications efficiently, while the frontend is deployed on Vercel for fast and optimized delivery.
